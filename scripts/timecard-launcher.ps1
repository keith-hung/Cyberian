...
$Bin = Join-Path $CacheDir "timecard-cli.exe"
...
# Download binary
$Url = "https://github.com/$Repo/releases/download/$Version/timecard-cli_windows_${Arch}.exe"
if (-not (Test-Path $CacheDir)) {
    New-Item -ItemType Directory -Path $CacheDir -Force | Out-Null
}

[Console]::Error.WriteLine("Downloading timecard-cli $Version for windows/${Arch}...")
try {
