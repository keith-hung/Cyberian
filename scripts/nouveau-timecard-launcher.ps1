...
# Download binary
$Url = "https://github.com/$Repo/releases/download/$Version/nouveau-timecard-cli_windows_${Arch}.exe"
if (-not (Test-Path $CacheDir)) {
    New-Item -ItemType Directory -Path $CacheDir -Force | Out-Null
}

[Console]::Error.WriteLine("Downloading nouveau-timecard-cli $Version for windows/${Arch}...")
try {
