...
```bash
claude plugin add github:keith-hung/Cyberian
```
...
```bash
claude plugin add github:keith-hung/Cyberian --scope project
```
...
```bash
claude plugin add github:keith-hung/Cyberian --scope local
```
