...
| **Nouveau Timecard** 新版工時 | 沿用 `TIMECARD_*`（同上）、選用 `TIMECARD_INSECURE`            |
...
| **nouveau-timecard** | 新版工時系統工時填報 | 工時填報、新版工時、同步休假  |
...
├── nouveau-timecard-cli/ Go CLI — 新版工時系統工時填報（草稿）
...
### nouveau-timecard-cli — 新版工時系統工時填報
