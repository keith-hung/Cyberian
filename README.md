...
| **Azure DevOps**    | `AZDO_BASE_URL`、`AZDO_COLLECTION`、`AZDO_DOMAIN`、`AZDO_USERNAME`、`AZDO_PASSWORD`、`AZDO_PROJECT`*、`AZDO_REPO`*、`AZDO_API_VERSION`* |
...
| **azuredevops**      | Azure DevOps 操作 | PR、pull request、code review、Azure DevOps |
